...
5. **Bootstrapping token-efficiency tools** (RTK, Caveman, claude-mem) and session-hygiene defaults.
...
| Token-efficiency bootstrap | Thin integration for RTK, Caveman, claude-mem. |
...
| `token-efficiency` | RTK, Caveman, claude-mem | Optional. |
