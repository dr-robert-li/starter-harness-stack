...
5. **Bootstrapping token-efficiency tools** (RTK, Caveman, claude-mem, Headroom) and session-hygiene defaults.
...
| Token-efficiency bootstrap | Thin integration for RTK, Caveman, claude-mem, Headroom. |
...
| `delivery-method` | BMAD-METHOD, agent-os, GSD Core, roborev, Claude Code Review guidance | Optional. |
| `security-preflight` | security-guidance, Bumblebee, optional eliate fallback | Optional. |
| `token-efficiency` | RTK, Caveman, claude-mem, Headroom | Optional. |
