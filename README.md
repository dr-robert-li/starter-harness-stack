...
5. **Bootstrapping token-efficiency tools** (RTK, Caveman, claude-mem, graphify) and session-hygiene defaults.
...
| Token-efficiency bootstrap | Thin integration for RTK, Caveman, claude-mem, graphify. |
...
| `delivery-method` | BMAD-METHOD, agent-os, roborev, Claude Code Review guidance | Optional. |
| `security-preflight` | security-guidance, Bumblebee, optional eliate fallback | Optional. |
| `token-efficiency` | RTK, Caveman, claude-mem, graphify | Optional. |
